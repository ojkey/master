# NumberField Add-on for Vaadin 7

NumberField is an UI component add-on for Vaadin 7.
...
Official releases of this add-on are available at Vaadin Directory. For Maven instructions, download and reviews, go to http://vaadin.com/addon/numberfield

## Building and running demo

git clone <url of the NumberField repository>
mvn clean install
cd demo
mvn jetty:run
...
NumberField JavaDoc is available online at <...>